  ...
  def render(assigns) do
        ...
        <ul class="space-y-2 font-medium">
           ...
           <li>
              ...
              <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    ...
                    <li>
                       <a href="#" id="humidity-card" data-target="temperature" draggable="true"  class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                       Humidity
                       </a>
                    </li>
                    <li>
    ...
    <div class="p-4 sm:ml-64">
      <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
          ...
          <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800 dropzone" data-target="temperature">
          ...
          <div class="flex items-center justify-center h-48 mb-4 rounded bg-gray-50 dark:bg-gray-800 dropzone" data-target="temperature">
            <p class="text-2xl text-gray-400 dark:text-gray-500">
                <svg class="w-3.5 h-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16"/>
                </svg>
    ...
    <div class="p-4 sm:ml-64 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 grid-rows-2 gap-4 ">
      <%!-- Temperature --%>
      <div id="temperature-card" data-target="temperature" class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" draggable="true" style="z-index: 999;">
